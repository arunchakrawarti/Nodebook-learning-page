...
//   return (
//     <div
//       className="w-full max-w-[340px] bg-white rounded-xl overflow-hidden shadow-md 
...
//         {/* Title */}
//         <h1 className="font-workSans font-semibold text-base sm:text-lg text-gray-900 mb-2">
//           {title}
//         </h1>
...
//         {isPricingCard ? (
//           <>
//             <p className="font-normal text-sm sm:text-base text-gray-600 mb-3 line-clamp-2">
//               {description}
//             </p>
...
//         ) : (
//           <>
//             <p className="font-normal text-xs sm:text-sm text-blue-600 cursor-pointer hover:underline mb-1">
//               {linkText}
//             </p>
