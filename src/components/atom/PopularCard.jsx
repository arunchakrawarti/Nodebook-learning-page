...
const PopularCard = ({ img, title, price, originalPrice, badges }) => {
  ...
  return (
    <Link href="course-internal/#detail"
      className="w-full sm:w-[48%] lg:w-[23%] p-2 border border-gray-200 rounded-lg shadow-sm hover:shadow-2xl transition duration-300 ease-in-out bg-white block"
    >
      {/* Image Section */}
