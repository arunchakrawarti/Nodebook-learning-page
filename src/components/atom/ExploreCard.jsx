...
const ExploreCard = ({
  ...
  return (
    <div className={`w-full max-w-[500px] ${bgColorClass} p-4 sm:p-6 rounded-xl shadow-md flex flex-col gap-4`}>
      ...
      <div className="flex gap-4 sm:gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="font-montserrat text-sm sm:text-base text-gray-700 leading-snug">
            {address}
          </p>
      ...
      <div className="flex justify-end">
        <a
          href={mapLink}
          target="_blank"
          className="flex items-center gap-1 text-indigo-600 font-semibold hover:opacity-80"
        >
          <MapPin size={18} />
          View Map
        </a>
