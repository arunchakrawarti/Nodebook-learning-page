...
//   return (
//     <div className="relative w-full py-14 px-4 sm:px-6 md:px-10 lg:px-8 bg-[#F5F6FF] overflow-hidden">
...
//           {/* Line — desktop only */}
//           <div className="hidden lg:block  h-[4px] border-t-4 border-dashed border-blue-400" />
...
//         {/* Cardicon grid */}
//         <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 sm:gap-8 md:gap-5 place-items-center">
